...
const pickUpCheckIn = async (req, res, next) => {
    try {
        await bookingService.pickUpCheckIn(req.user._id, req.params.bookingId);
...
const getEstimatedPrice = async (req, res, next) => {
    try {
        const price = await bookingService.getEstimatedPrice(req.body.origin, req.body.destination, req.body.vehicleType);
...
const getEstimatedPricesForAllVehicleTypes = async (req, res, next) => {
    try {
        const vehicleTypes = await bookingService.getEstimatedPricesForAllVehicleTypes(req.body.origin, req.body.destination);
